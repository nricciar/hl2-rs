...
//!   * [`sai1`]     — slave TX, 16-bit samples in 32-bit stereo slots.
...
//! calls [`sink::process_chunk`] on DMA completion (about every 20 ms).
//! Everything between the two rides on the cross-task ring.
